export default class CommonData {
    ...
    static currentVersion = 29
    static googleLoginClientId = "480545727884-oup0gshcscesa4fq3s8rhoh4tpeopcha.apps.googleusercontent.com"

    static dataUrl = CommonData.url
    static jacketUrl = "https://s3-bc-imgserv.s3.ap-northeast-2.amazonaws.com/sinjacket/"
