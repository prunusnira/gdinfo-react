            ...
            <BodyContent>
                <ItemRow style={{justifyContent: 'center'}}>
                    <a className="innerhref" href="#no_div" onClick={props.showTableMenu}>
                        {(txtSkill.float as any)[props.lang]}
                    </a>
                </ItemRow>
                                    ...
                                    <ItemCol size={5}>
                                        <Button
                                            ...
                                            onClick={() => props.switchOrder(0)}>
                                                {(txtSkill.filter.btn.title as any)[props.lang]} ▲/▼
                                        </Button>
                                    </ItemCol>
                                    <ItemCol size={5}>
                                        <Button
                                            ...
                                            onClick={() => props.switchOrder(1)}>
                                                {(txtSkill.filter.btn.version as any)[props.lang]} ▲/▼
                                        </Button>
                                    </ItemCol>
                                </ItemRow>
                            </BodyContent>
                        ...
                        </Row>
                        {
                            (function() {
                                if(props.skillTable1.length === 0) {
                                    return (txtSkill.tablehead.empty as any)[props.lang]
                                }
                            })()
                        }
                    </ItemRow>
