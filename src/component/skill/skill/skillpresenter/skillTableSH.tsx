                ...
                return (
                    ...
                    >
                        <Row>
                            ...
                            >
                                <div className="text-center" style={v.tableColor}>
                                    <b
                                        style={{
                                            textShadow:
                        ...
                        <Row>
                            ...
                            >
                                <b style={{ wordBreak: "break-all" }}>{v.musicTitle}</b>
                            </Col>
                        </Row>
                        <Row>
                            <Col xs="4" className="text-center zerogap">
                                <img
                                    className="zerogap"
                                    alt="jacket-img"
                                    style={{ width: "40px" }}
