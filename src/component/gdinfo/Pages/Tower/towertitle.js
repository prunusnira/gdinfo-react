...
export const getFloorTitle = (tower, floor, rate, allfloors) => {
	// 타이틀 목록 가져오기
	let titleshort = "";
...
export const musicTitlePopup = (mid, ptcode, div) => {
...
export const popupRemove = (div) => {
	div.hide();
}

export const setTitle = (userid, currentTitleValue, jqdiv) => {
	// 확정된 칭호를 프로필 DB에 등록
...
export const getTowerTitle = (userid, handler) => {
...
export const checkFloorTitleExist = (towername) => {
	let exist = true;
...
export const checkMusicTitleExist = (mid, ptcode) => {
	let isExist = false;
...
export const addTowerTitleImage = (type, title) => {
