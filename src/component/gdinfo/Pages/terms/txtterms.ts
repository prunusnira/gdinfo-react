...
const txtTerms = {
    ...
    s2c1: {
        ...
        "en":"You can have restriction (Record delete, IP block) on using service from:"
    },
    s2c2: {
        "jp":"1) サーバーに負担をかける行為",
        "ko":"1) 서버에 부하를 가하는 행위",
        "en":"1) Overload on server"
    },
    s2c3: {
    ...
    s3c1: {
        "jp":"1) サービス提供者はサービスの維持が難しいと判断される時にサービスを中止できます",
        "ko":"1) 서비스 제공자는 제공이 어렵거나 필요하다고 판단되는 경우 일시 혹은 영구적으로 서비스를 중지할 수 있습니다.",
        "en":"1) Service provider can stop service temporary or permanently due to any reasons that makes hard to keep service"
    },
    s3c2: {
        "jp":"2) サービス提供者はサービス利用中eAmusementサービスからの警告や制限に責任を持っていません",
        "ko":"2) 서비스 제공 중 eAmusement 서비스로부터의 제재나 밴에 대해 서비스 제공자는 책임지지 않습니다.",
        "en":"2) Service provider does not have any responsibility on service restriction or BAN from eAmusement service by using this service"
    },
    s4t: {
        "jp":"4. 収集情報",
        "ko":"4. 수집 정보",
