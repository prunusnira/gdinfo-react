...
const PlayCountPresenter = (props: Props) => {
    ...
    return (
        <PCContainer>
            ...
            <PCBtnWrapper>
                <Button onClick={() => setListData(props.plist)}>{txtPlayCount.button.pt}</Button>
                <Button onClick={() => setListData(props.mlist)}>
                    {txtPlayCount.button.music}
                </Button>
                <Button onClick={() => setListData(props.glist)}>{txtPlayCount.button.gf}</Button>
                <Button onClick={() => setListData(props.dlist)}>{txtPlayCount.button.dm}</Button>
            </PCBtnWrapper>
