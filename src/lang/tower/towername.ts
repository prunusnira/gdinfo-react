...
export const towerDesc = {
    towerDmDKDK: {
        jp: "(BPM) 1階: 130未満, 2階: 130~150, 3階: 150以上, 4階: 140未満 (EX), 5階: 140~170 (EX), 6階: 170~190, 7階: 190以上 youtu.be/zgQMe-jKxtE",
        ko: "(BPM 기준) 1층: 130 미만, 2층: 130~150, 3층: 150 이상, 4층: 140 미만 (EX), 5층: 140~170 (EX), 6층: 170~190, 7층: 190 이상 youtu.be/zgQMe-jKxtE",
        en: "(BPM) 1F: Under 130, 2F: 130~150, 3F: Over 150, 4F: Under 140 (EX), 5F: 140~170 (EX) 6F: 170~190, 7F: Over 190 youtu.be/zgQMe-jKxtE",
    },
    towerDmLeftPedal: {
        jp: "同時踏み、４・８ビートの左足などを練習する塔でございます youtu.be/y_wyqiovt_w",
        ko: "뚜벅이, 왼발곡들, 동시밟기, 4/8비트 햇페달 등을 연습할 수 있는 탑입니다 youtu.be/y_wyqiovt_w",
        en: "This tower is for the practicing left pedal. You can practice 4/8beat pedals or pressing both pedals at the same time. youtu.be/y_wyqiovt_w",
    },
    towerDmNote: {
        jp:
            "連打、タム、体力パターンなど色んなパターンのノーツを練習できる塔です。<br/>" +
            "S: 連打, T: タム, P: 体力",
        ko:
            "연타, 탐, 체력곡 등 다양한 패턴의 노트를 연습할 수 있는 탑입니다.<br/>" +
            "S: 연타, T: 탐, P: 체력",
        en:
            "This tower is for practicing notes that has stroke, tom and patterns that needs physical.<br/>" +
